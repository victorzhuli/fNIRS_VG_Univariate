%%%% 05/29/2017
%%%% adapted from https://stackoverflow.com/questions/16146212/how-to-plot-a-hyper-plane-in-3d-for-the-svm-results/19969412#19969412
...
figure
plot3(Xdata1(t, 1), Xdata1(t, 2), Xdata1(t, 3), 'r+',  'markersize', 20);
hold on
plot3(Xdata1(~t, 1), Xdata1(~t, 2), Xdata1(~t, 3), 'b.',  'markersize', 30);
hold on
% load unscaled support vectors for plotting
sv = svmStruct.SupportVectorIndices;
sv = [Xdata1(sv, :)];
plot3(sv(:, 1), sv(:, 2), sv(:, 3), 'go', 'markersize', 10);
